...
const ChatWidget = ({ apiEndpoint, bookUrl }) => {
  ...
  const loadChatHistory = () => {
    // This would load from local storage or server in a real implementation
        ...
        <div className="chat-container">
          <div className="chat-header">
            ...
            <div className="chat-controls">
              ...
              <button onClick={loadChatHistory} className="history-btn" title="Load chat history">
                ↻
              </button>
